...
ALTER TABLE "operation_log" ADD CONSTRAINT "operation_log_operatorId_admin_user_id_fk" FOREIGN KEY ("operatorId") REFERENCES "public"."admin_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_event_time" ON "event" USING btree ("time" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "idx_event_event_time" ON "event" USING btree ("event","time" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "idx_event_user_id" ON "event" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_event_session_id" ON "event" USING btree ("session_id");--> statement-breakpoint
CREATE INDEX "idx_event_created_at" ON "event" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_system_config_group" ON "system_config" USING btree ("group_name");