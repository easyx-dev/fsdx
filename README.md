...
基于 TanStack Start 构建的全栈开发工程基座。内置双端认证/RBAC、事件埋点、国际化、缓存、审计、文件存储等基础设施，支持管理端和客户端前台，并附新闻业务示例，可快速扩展为任意业务系统。
...
| [管理端设计规范](docs/admin-design.md) | 页头三段式、筛选落点、列宽预算、操作列、弹窗与抽屉、表单、状态与反馈、分析页（规则本体见 `.agents/skills/admin-design`） |
