...
- **业务层**：业务示例模块（news）、具体业务表/字段、具体业务路由、示例内容。注：dict / files · file-explorer / messages / config / translations / track / operation-logs / ai-providers / ai-rich-editor / demo 等均为基建能力，非业务示例。
